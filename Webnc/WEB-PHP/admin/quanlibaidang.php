    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Danh sách bài viết</h3>
            </div>
        </div>
        ...
        <div class="flex flex-wrap">
                ...
                <div class="bg-gradient-to-b from-indigo-200 to-indigo-100 border-b-4 border-indigo-500 rounded-lg shadow-xl p-5">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-gray-600">Số Bài
                                viết</h5>
                            <h3 class="font-bold text-3xl"><?= $totalRecords ?>
                                bài</h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full p-6 flex flex-row-reverse">
                ...
                <button class=" ml-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
                    <a
                            href="./thembaidang.php">Thêm bài đăng</a>
                </button>
                <div class="mr-2 flex items-center justify-center ">
                    <form action="quanlibaidang.php?action=search" method="POST">
                        <div class="flex ">
                            <input type="text"
                                   class="border-2 border-gray-200 rounded px-2 py-2 w-30"
                                   placeholder="Nhập id bài đăng ..." name="id"
                                   value="<?= !empty($id) ? $id : "" ?>"/>
                            <input type="text"
                                   class="border-2 border-gray-200 rounded mr-2 px-2 ml-2 py-2 w-30"
                                   placeholder="Nhập tên bài đăng ..." name="tieude"
            ...
            <div class="w-full p-6">
                <table id="table_customers">
                    ...
                    <tr class="border-2">
                        ...
                        <th class="w-2/12 ">Tiêu đề</th>
                        <th class="w-1/12 ">Người phụ trách</th>
                        <th class="w-1/12 ">Ảnh đại diện</th>
                        <th class="w-1/12 ">Chế độ</th>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center doimau"><a
                                            href="./edit_qlbaidang.php?id=<?= $row['id'] ?>">Sửa</a>
                                </td>
                                <td class="text-center doimau"><a
                                            href="./delete_qlbaidang.php?id=<?= $row['id'] ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                        } ?>
