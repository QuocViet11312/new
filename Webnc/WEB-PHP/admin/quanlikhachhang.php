    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Danh sách khách hàng</h3>
            </div>
        </div>
        ...
        <div class="flex flex-wrap">
                ...
                <div class="bg-gradient-to-b from-indigo-200 to-indigo-100 border-b-4 border-indigo-500 rounded-lg shadow-xl p-5">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-gray-600">Số
                                khách hàng</h5>
                            <h3 class="font-bold text-3xl"><?= $totalRecords ?> khách hàng</h3>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
            ...
            <div class="w-full p-4 flex flex-row-reverse">
                ...
                <div class="mr-8 flex items-center justify-center ">
                    <form action="quanlikhachhang.php?action=search" method="POST">
                        <div class="flex ">
                            <input type="text"
                                   class="border-2 border-gray-200 rounded px-2 py-2 w-30"
                                   placeholder="Nhập mã khách hàng ..." name="makh"
                                   value="<?=!empty($makh)?$makh:""?>"/>
                            <input type="text"
                                   class="border-2 border-gray-200 rounded mr-2 px-2 ml-2 py-2 w-30"
                                   placeholder="Nhập tên khách hàng ..." name="hoten"
            ...
            <div class="flex w-full mr-8 justify-end">
                <div>Có tất cả <strong><?=$totalRecords?></strong> sản phẩm trên <strong><?=$totalPages?></strong> trang</div>
            </div>
            <div class="w-full p-6">
                <table id="table_customers">
                    <thead class="bg-blue-300">
                    <tr class="border-2">
                        <th class="w-2/12 ">Mã khách hàng</th>
                        <th class="w-3/12 ">Tên đăng nhập</th>
                        <th class="w-3/12 ">Họ tên</th>
                        <th class="w-3/12 ">Ngày tạo</th>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center doimau"><a
                                            href="./delete_qlkhachhang.php?makh=<?= $row['makh'] ?>">Xoá</a>
                                </td>
