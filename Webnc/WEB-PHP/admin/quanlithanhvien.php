    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Danh sách thành viên</h3>
            </div>
        </div>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full p-4 flex flex-row-reverse">
                ...
                <div class="mr-8 flex items-center justify-center ">
                    <form action="quanlithanhvien.php?action=search" method="POST">
                        <div class="flex ">
                            <input type="text"
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Nhập Tên ..." name="hoten"
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center doimau"><a
                                            href="./edit_qlthanhvien.php?id=<?= $row['id'] ?>">Sửa</a>
                                </td>
                                <td class="text-center doimau"><a
                                            href="./delete_qlthanhvien.php?id=<?= $row['id'] ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                        } ?>
